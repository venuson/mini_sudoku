      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property({
        ...
        */
        ...
        async preloadAssets() {
          ...
          const loadPromises = []; // --- 定义需要加载的资源路径 ---
          ...
          const numberResources = [1, 2, 3, 4, 5, 6, 7, 8, 9]; // --- 加载 SpriteFrame ---
            ...
            loadPromises.push(new Promise(resolve => {
              resources.load(path, SpriteFrame, (err, frame) => {
                if (err || !frame) {
                  ...
                  this.loadedSpriteFrames.set(name, frame); // --- 缓存特定用途的 Frame ---
        ...
        updatePauseResumeButton(isPaused) {
          ...
          const iconName = isPaused ? (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
        ...
        updateUndoRedoButtons(canUndo, canRedo) {
          ...
          if (this.undoButton) {
            ...
            // 修改后的代码
            const undoOpacity = (_this$undoButton2 = this.undoButton) == null ? void 0 : _this$undoButton2.node.getComponent(UIOpacity);
        ...
        showSettingsPopup(initialSettings) {
          ...
          this.showPopup(this.settingsPopupPrefab, popupNode => {
            // --- 初始化弹窗内容 ---
            const controller = popupNode.getComponent(_crd && SettingsPopupController === void 0 ? (_reportPossibleCrUseOfSettingsPopupController({
              error: Error()
        ...
        showHistoryPopup(records) {
          this.showPopup(this.historyPopupPrefab, popupNode => {
            ...
            // }, this);
            const controller = popupNode.getComponent(_crd && HistoryPopupController === void 0 ? (_reportPossibleCrUseOfHistoryPopupController({
              error: Error()
        ...
        */
        ...
        populateRecordItem(itemNode, recordData) {
          ...
          const difficultyLabel = (_itemNode$getChildByN = itemNode.getChildByName('DifficultyLabel')) == null ? void 0 : _itemNode$getChildByN.getComponent(Label);
          const levelLabel = (_itemNode$getChildByN2 = itemNode.getChildByName('LevelLabel')) == null ? void 0 : _itemNode$getChildByN2.getComponent(Label);
          const timeLabel = (_itemNode$getChildByN3 = itemNode.getChildByName('BestTimeLabel')) == null ? void 0 : _itemNode$getChildByN3.getComponent(Label);
          const dateLabel = (_itemNode$getChildByN4 = itemNode.getChildByName('DateLabel')) == null ? void 0 : _itemNode$getChildByN4.getComponent(Label);
          const challengeButton = (_itemNode$getChildByN5 = itemNode.getChildByName('ChallengeButton')) == null ? void 0 : _itemNode$getChildByN5.getComponent(Button);
        ...
        showRankingPopup(ranks, myRank) {
          this.showPopup(this.rankingPopupPrefab, popupNode => {
            const controller = popupNode.getComponent(_crd && RankingPopupController === void 0 ? (_reportPossibleCrUseOfRankingPopupController({
              error: Error()
        ...
        populateRankItem(itemNode, rankData, isMyRank) {
          ...
          const rankLabel = (_itemNode$getChildByN6 = itemNode.getChildByName('RankLabel')) == null ? void 0 : _itemNode$getChildByN6.getComponent(Label);
          const avatarSprite = (_itemNode$getChildByN7 = itemNode.getChildByName('Avatar')) == null ? void 0 : _itemNode$getChildByN7.getComponent(Sprite); // 需要处理头像加载

          const nicknameLabel = (_itemNode$getChildByN8 = itemNode.getChildByName('NicknameLabel')) == null ? void 0 : _itemNode$getChildByN8.getComponent(Label);
          const scoreLabel = (_itemNode$getChildByN9 = itemNode.getChildByName('ScoreLabel')) == null ? void 0 : _itemNode$getChildByN9.getComponent(Label);
            ...
            if (rankData.avatarUrl) {
              ...
              assetManager.loadRemote(rankData.avatarUrl, {
                ...
                if (!err && isValid(avatarSprite.node)) {
                  ...
                  // 加载失败或节点失效，可以设置默认头像
                  const defaultAvatarFrame = this.getSpriteFrame((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                    error: Error()
