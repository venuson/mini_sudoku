    ...
    execute: function () {
      ...
      _export("SudokuLogic", SudokuLogic = class SudokuLogic {
        ...
        convertStringToBoardData(boardString, solutionString) {
          const boardData = (_crd && createEmptyBoardData === void 0 ? (_reportPossibleCrUseOfcreateEmptyBoardData({
            error: Error()
          ...
          for (let r = 0; r < (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            ...
            for (let c = 0; c < (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              ...
              const index = r * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              }), Constants) : Constants).GRID_SIZE + c;
        ...
        generateSudoku(difficulty, levelIndex) {
          ...
          for (const key in (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          ...
          const diffConfig = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          ...
          const targetEmpty = Math.round(diffConfig.start + (diffConfig.end - diffConfig.start) / ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).LEVELS_PER_DIFFICULTY - 1) * (levelIndex - 1)); // 2. 计算目标预设数字数量 (Givens)

          let targetGivens = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).GRID_SIZE * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
        ...
        isValidMove(boardData, row, col, num) {
          ...
          const boxStartRow = Math.floor(row / (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).BOX_SIZE) * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).BOX_SIZE;
          const boxStartCol = Math.floor(col / (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).BOX_SIZE) * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).BOX_SIZE;

          for (let r = boxStartRow; r < boxStartRow + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).BOX_SIZE; r++) {
            for (let c = boxStartCol; c < boxStartCol + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).BOX_SIZE; c++) {
        ...
        */
        ...
        isPartComplete(boardData, type, index) {
          ...
          if (type === 'row') {
            ...
            const boxStartRow = Math.floor(index / (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).BOX_SIZE) * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).BOX_SIZE;
            const boxStartCol = index % (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).BOX_SIZE * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).BOX_SIZE;
        ...
        solveSudoku(boardData) {
          try {
            ...
            if (solutionString) {
              ...
              const solvedBoard = (_crd && createEmptyBoardData === void 0 ? (_reportPossibleCrUseOfcreateEmptyBoardData({
                error: Error()
              }), createEmptyBoardData) : createEmptyBoardData)();
