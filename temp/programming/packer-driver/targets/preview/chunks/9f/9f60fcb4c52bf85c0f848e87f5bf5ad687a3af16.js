      ...
      _export("EffectsManager", EffectsManager = (_dec = ccclass('EffectsManager'), _dec2 = property({
        ...
        playWinEffect(parentNode, position) {
          ...
          if (isValid(this._winParticlesNode)) {
            ...
            var ps = this._winParticlesNode.getComponent(ParticleSystem2D);
            ...
            if (ps) {
              ...
              if (position) {
                ...
                var parentUITransform = parentNode.getComponent(UITransform);
          ...
          if (position) {
            ...
            var _parentUITransform = parentNode.getComponent(UITransform);

            if (_parentUITransform) {
              console.log('[EffectsManager] 设置粒子位置为:', 0, -_parentUITransform.height / 2, 0);

              this._winParticlesNode.setPosition(0, -_parentUITransform.height / 2, 0);
            } else {
          ...
          var particleSystem = this._winParticlesNode.getComponent(ParticleSystem2D);
        ...
        animateNumberAppear(targetNode, callback) {
          ...
          var uiOpacity = targetNode.getComponent(UIOpacity) || targetNode.addComponent(UIOpacity);
          uiOpacity.opacity = 0;
        ...
        animateNumberDisappear(targetNode, callback) {
          ...
          var uiOpacity = targetNode.getComponent(UIOpacity) || targetNode.addComponent(UIOpacity); // 创建并执行动画
