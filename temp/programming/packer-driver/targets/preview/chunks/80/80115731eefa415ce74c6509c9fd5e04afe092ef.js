      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property({
        ...
        */
        ...
        setupInitialUIState() {
          ...
          var actionButtonContainer = (_this$clearButton = this.clearButton) == null ? void 0 : _this$clearButton.node.parent;
          ...
          var topBarContainer = (_this$timerLabel = this.timerLabel) == null ? void 0 : _this$timerLabel.node.parent;
        ...
        showGameUI() {
          ...
          var actionButtonContainer = (_this$clearButton3 = this.clearButton) == null ? void 0 : _this$clearButton3.node.parent;
          if (actionButtonContainer) actionButtonContainer.active = true;else warn('[UIManager] 功能按钮容器未找到。');
          var topBarContainer = (_this$timerLabel2 = this.timerLabel) == null ? void 0 : _this$timerLabel2.node.parent;
        ...
        showDifficultySelection() {
          ...
          var actionButtonContainer = (_this$clearButton4 = this.clearButton) == null ? void 0 : _this$clearButton4.node.parent;
          if (actionButtonContainer) actionButtonContainer.active = true;else console.warn('[UIManager] 功能按钮容器未找到。');
          var topBarContainer = (_this$timerLabel3 = this.timerLabel) == null ? void 0 : _this$timerLabel3.node.parent;
