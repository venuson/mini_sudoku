System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, TimeFormatter, _crd;

  _export("TimeFormatter", void 0);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "87107fXaUFO556JFIpSBavS", "TimeFormatter", undefined);

      // assets/scripts/utils/TimeFormatter.ts
      // 引入 cc 模块以消除可能的警告，虽然这里没用到装饰器
      ...
      _export("TimeFormatter", TimeFormatter = class TimeFormatter {
        /**
        ...
        static formatSeconds(totalSeconds) {
          ...
          var secondsInt = Math.floor(totalSeconds); // 计算分钟和剩余秒数

          var minutes = Math.floor(secondsInt / 60);
          var seconds = secondsInt % 60; // 使用 padStart 补零，确保总是两位数
        ...
        static formatSecondsWithHours(totalSeconds) {
          // 处理无效输入
          if (isNaN(totalSeconds) || totalSeconds < 0) {
            totalSeconds = 0;
          }

          var secondsInt = Math.floor(totalSeconds);
...
//# sourceMappingURL=c085f97085d85fad584a0de15d0aa0427639c7df.js.map